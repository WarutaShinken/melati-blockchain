...
electron-packager . Melati --asar.unpack="**/daemon/**" --platform=darwin \
...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Melati-darwin-arm64/Melati.app --platform=darwin \
...
mv Melati-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Melati-$MELATI_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Melati-darwin-arm64/Melati.app Melati-$MELATI_INSTALLER_VERSION-arm64 \
...
# xcrun altool --notarize-app -f Melati-0.1.X.dmg --primary-bundle-id net.melati.blockchain -u username -p password
...
# xcrun stapler staple Melati-0.1.X.dmg
#
# Validate DMG:
# xcrun stapler validate Melati-0.1.X.dmg
