...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Melati-darwin-x64/Melati.app --platform=darwin \
...
mv Melati-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Melati-$MELATI_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Melati-darwin-x64/Melati.app Melati-$MELATI_INSTALLER_VERSION \
