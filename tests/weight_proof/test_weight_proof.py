...
from melati.server.start_full_node import SERVICE_NAME
...
from melati.consensus.pot_iterations import calculate_iterations_quality
from melati.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
