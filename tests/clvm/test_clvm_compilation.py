...
from melati.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "melati/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "melati/wallet/puzzles/cc.clvm",
        "melati/wallet/puzzles/melatilisp_deserialisation.clvm",
        "melati/wallet/puzzles/rom_bootstrap_generator.clvm",
        "melati/wallet/puzzles/generator_for_single_coin.clvm",
        "melati/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "melati/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "melati/wallet/puzzles/lock.inner.puzzle.clvm",
        "melati/wallet/puzzles/p2_conditions.clvm",
        "melati/wallet/puzzles/p2_delegated_conditions.clvm",
        "melati/wallet/puzzles/p2_delegated_puzzle.clvm",
        "melati/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "melati/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "melati/wallet/puzzles/p2_puzzle_hash.clvm",
        "melati/wallet/puzzles/rl_aggregation.clvm",
        "melati/wallet/puzzles/rl.clvm",
        "melati/wallet/puzzles/sha256tree_module.clvm",
        "melati/wallet/puzzles/singleton_top_layer.clvm",
        "melati/wallet/puzzles/did_innerpuz.clvm",
        "melati/wallet/puzzles/decompress_puzzle.clvm",
        "melati/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "melati/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "melati/wallet/puzzles/block_program_zero.clvm",
        "melati/wallet/puzzles/test_generator_deserialize.clvm",
        "melati/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "melati/wallet/puzzles/p2_singleton.clvm",
        "melati/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "melati/wallet/puzzles/pool_member_innerpuz.clvm",
        "melati/wallet/puzzles/singleton_launcher.clvm",
        "melati/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["melati/wallet/puzzles/create-lock-puzzlehash.clvm", "melati/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "melati/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to melati/wallet/puzzles, but not added to `wallet_program_files`
        """
