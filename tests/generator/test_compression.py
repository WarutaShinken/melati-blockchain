...
from melati.full_node.generator import run_generator, create_generator_args
from melati.types.blockchain_format.program import Program, SerializedProgram, INFINITE_COST
from melati.types.generator_types import BlockGenerator, CompressorArg, GeneratorArg
...
from melati.wallet.puzzles.load_clvm import load_clvm
...
TEST_GEN_DESERIALIZE = load_clvm("test_generator_deserialize.clvm", package_or_requirement="melati.wallet.puzzles")
DESERIALIZE_MOD = load_clvm("melatilisp_deserialisation.clvm", package_or_requirement="melati.wallet.puzzles")
...
TEST_MULTIPLE = load_clvm("test_multiple_generator_input_arguments.clvm", package_or_requirement="melati.wallet.puzzles")
