...
from melati.pools.pool_wallet_info import PoolWalletInfo, PoolSingletonState
from melati.protocols import full_node_protocol
from melati.protocols.full_node_protocol import RespondBlock
from melati.rpc.rpc_server import start_rpc_server
from melati.rpc.wallet_rpc_api import WalletRpcApi
from melati.rpc.wallet_rpc_client import WalletRpcClient
from melati.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
...
from melati.wallet.derive_keys import master_sk_to_local_sk
...
class TestPoolWalletRpc:
    ...
    async def test_leave_pool(self, setup):
        ...
        try:
            ...
            async def have_melati():
                await self.farm_blocks(full_node_api, our_ph, 1)
                return (await wallets[0].get_confirmed_balance()) > 0

            await time_out_assert(timeout=WAIT_SECS, function=have_melati)
