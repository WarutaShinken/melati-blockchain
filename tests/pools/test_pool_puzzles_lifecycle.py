...
from melati.wallet.puzzles.p2_conditions import puzzle_for_conditions
from melati.wallet.puzzles import singleton_top_layer
from melati.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - melati.pools.pool_puzzles.py
    - melati.wallet.puzzles.pool_member_innerpuz.clvm
    - melati.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
