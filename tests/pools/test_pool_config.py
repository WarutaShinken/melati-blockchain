...
from melati.pools.pool_config import PoolWalletConfig
from melati.util.config import load_config, save_config, create_default_melati_config
...
def test_pool_config():
    ...
    create_default_melati_config(test_root, ["config.yaml"])
