...
from melati.timelord.iters_from_block import iters_from_block
from melati.timelord.timelord_state import LastState
from melati.timelord.types import Chain, IterationType, StateType
from melati.types.blockchain_format.classgroup import ClassgroupElement
from melati.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[MelatiServer] = None
