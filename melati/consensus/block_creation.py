...
from melati.consensus.coinbase import create_farmer_coin, create_pool_coin
...
from melati.types.blockchain_format.reward_chain_block import RewardChainBlock, RewardChainBlockUnfinished
