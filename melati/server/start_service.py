...
from melati.daemon.server import singleton, service_launch_lock_path
from melati.server.ssl_context import melati_ssl_ca_paths, private_ssl_ca_paths
...
from melati.util.config import load_config, load_config_cli
...
class Service:
    def __init__(
        ...
        proctitle_name = f"melati_{service_name}"
        ...
        melati_ca_crt, melati_ca_key = melati_ssl_ca_paths(root_path, self.config)
