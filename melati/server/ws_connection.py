...
from melati.cmds.init_funcs import melati_full_version_str
from melati.protocols.protocol_message_types import ProtocolMessageTypes
from melati.protocols.shared_protocol import Capability, Handshake
...
from melati.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from melati.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSMelatiConnection:
    """
