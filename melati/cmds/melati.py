...
from melati.cmds.configure import configure_cmd
from melati.cmds.farm import farm_cmd
from melati.cmds.init import init_cmd
from melati.cmds.keys import keys_cmd
from melati.cmds.netspace import netspace_cmd
from melati.cmds.plots import plots_cmd
from melati.cmds.show import show_cmd
from melati.cmds.start import start_cmd
from melati.cmds.stop import stop_cmd
from melati.cmds.wallet import wallet_cmd
from melati.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage melati blockchain infrastructure ({__version__})\n",
    epilog="Try 'melati start node', 'melati netspace -d 192', or 'melati show -s'",
...
@cli.command("version", short_help="Show melati version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs melati daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from melati.daemon.server import async_run_daemon
    import asyncio
