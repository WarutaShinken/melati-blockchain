...
from melati.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic
...
def generate_and_print():
    ...
    print(mnemonic)
    print("Note that this key has not been added to the keychain. Run melati keys add")
    return mnemonic
...
def show_all_keys(show_mnemonic: bool):
    ...
    for sk, seed in private_keys:
        ...
        print(
            "Farmer public key (m/12381/2444/0/0):",
            master_sk_to_farmer_sk(sk).get_g1(),
        )
        print("Pool public key (m/12381/2444/1/0):", master_sk_to_pool_sk(sk).get_g1())
        print(
        ...
        if show_mnemonic:
            ...
            print(
                "First wallet secret key (m/12381/2444/2/0):",
