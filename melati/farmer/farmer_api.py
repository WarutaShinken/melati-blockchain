...
from melati.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from melati.farmer.farmer import Farmer
from melati.protocols import farmer_protocol, harvester_protocol
from melati.protocols.harvester_protocol import PoolDifficulty
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSMelatiConnection
    ):
        """
