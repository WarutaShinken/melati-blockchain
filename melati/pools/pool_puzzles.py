...
from melati.clvm.singleton import SINGLETON_LAUNCHER
from melati.consensus.block_rewards import calculate_pool_reward
from melati.consensus.coinbase import pool_parent_id
from melati.pools.pool_wallet_info import PoolState, LEAVING_POOL, SELF_POOLING
...
from melati.wallet.puzzles.singleton_top_layer import puzzle_for_singleton
...
def solution_to_extra_data(full_spend: CoinSolution) -> Optional[PoolState]:
    ...
    if num_args == 2:
        ...
        # This is referred to as p1 in the melatilisp code
