...
from melati.server.server import NodeType, ssl_context_for_client
from melati.server.ssl_context import private_ssl_ca_paths
...
class RpcClient:
    """
    Client to Melati RPC, connects to a local service. Uses HTTP/JSON, and converts back from
