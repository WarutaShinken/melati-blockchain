...
from melati.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "melati" in cc_discrepancies:
                    cc_discrepancies["melati"] = cc_discrepancies["melati"] + diff
                else:
                    cc_discrepancies["melati"] = diff
