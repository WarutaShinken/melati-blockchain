...
from melati.consensus.cost_calculator import calculate_cost_of_program, NPCResult
...
from melati.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from melati.wallet.puzzles.puzzle_utils import (
...
from melati.wallet.secret_key_store import SecretKeyStore
from melati.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_melati(self, melati_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if melati_amount < 0:
            utxos = await self.select_coins(abs(melati_amount), exclude)
        else:
        ...
        melati_amount = spend_value + melati_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": melati_amount}]
