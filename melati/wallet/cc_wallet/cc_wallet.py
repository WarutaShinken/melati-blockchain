...
from melati.protocols.wallet_protocol import PuzzleSolutionResponse
...
from melati.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict
...
from melati.wallet.cc_wallet.cc_info import CCInfo
from melati.wallet.cc_wallet.cc_utils import (
    CC_MOD,
    SpendableCC,
...
from melati.wallet.puzzles.genesis_by_coin_id_with_0 import (
