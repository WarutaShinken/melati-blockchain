...
from melati.util.ints import uint64, uint32
...
from melati.full_node.bundle_tools import simple_solution_generator
...
from melati.consensus.coinbase import create_pool_coin, create_farmer_coin
from melati.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward
from melati.consensus.cost_calculator import NPCResult

"""
The purpose of this file is to provide a lightweight simulator for the testing of Melatilisp smart contracts.
...
There is also a provided NodeClient object which implements many of the methods from melati.rpc.full_node_rpc_client
